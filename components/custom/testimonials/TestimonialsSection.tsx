    ...
    <section className="testimonials" ref={sectionRef}>
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          <div className="testimonials__eyebrow">Real NYC Customer Reviews</div>
          <h2 className="testimonials__heading">Trusted When It Matters Most</h2>
          <p className="testimonials__subtext">
            NYC homeowners and businesses have relied on Hub Plumbing &amp; Mechanical for over
            25 years. See what our customers say about our Red Carpet Service, fast response,
            and guaranteed workmanship across Manhattan, Brooklyn, and Queens.
          </p>
        </div>
