          ...
          <div className="front-insights__head py-0 md:py-50">
            ...
            <div className="content-entry ia-white max-w-2xl">
              <p className="ia-white">
                From water heater failures to boiler violations, select a service below to see
                exactly how Hub Plumbing handles it — and what you can expect from first call to
                final cleanup.
              </p>
            </div>
          </div>
