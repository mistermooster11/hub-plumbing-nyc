      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About Hub Plumbing &amp; Mechanical
          </h2>
          <p className="faq__subtext">
            Find answers about our NYC plumbing services, licensing, service areas, emergency
            response, and what to expect when you call Hub Plumbing &amp; Mechanical.
          </p>
