...
const BENEFITS = [
  ...
  },
  {
    num: "04",
    title: "Grow With Us",
    text: "Join a fast-growing company serving all five NYC boroughs with room to advance.",
  },
];
    ...
    <section className="become-section" ref={sectionRef}>
      <div className="become-section__inner">
        <p className="become-section__intro">
          Hub Plumbing &amp; Mechanical is growing its team of licensed NYC plumbers across Manhattan, Brooklyn &amp; Queens.
          If you are a motivated, skilled professional looking for a rewarding career in residential and commercial plumbing,
