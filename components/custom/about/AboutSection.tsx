      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <h2 className="about__heading">
            NYC&rsquo;s Licensed Plumbing &amp; Heating Specialists
            Since 1999
          </h2>
          <p className="about__text">
            Hub Plumbing &amp; Mechanical is a licensed NYC plumbing and heating
            company serving Manhattan, Brooklyn, and Queens for over 25 years.
            We bring expert technicians, honest pricing, and Red Carpet Service
            to every home and business we serve.
          </p>
          <p className="about__text">
            We hold NYC Master Plumber License #2305 and are NY State Certified
            Backflow Prevention Specialists. From a dripping faucet to a full
            plumbing remodel, we handle it all — with the same standard of
            quality every time.
          </p>
        ...
        <div className="about__media">
          <div className="about__img-wrap">
            <Image
              ...
              alt="Hub Plumbing technician at work"
              width={690}
              height={613}
