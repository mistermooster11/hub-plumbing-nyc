    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Expert Plumbing Services in Manhattan, Brooklyn &amp; Queens
        </h2>
        <p className="services__subtext">
          From clogged drains and hidden leaks to water heater failures and emergency repairs —
          Hub Plumbing &amp; Mechanical handles it all with licensed technicians, upfront pricing,
          and Red Carpet Service on every job.
        </p>
      </div>
