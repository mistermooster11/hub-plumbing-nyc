    ...
    <section className="pricing" ref={sectionRef}>
      ...
      <div className="pricing__header">
        ...
        <p className="pricing__subtext">
          Clear and upfront pricing for residential and commercial plumbing repairs,
          drain cleaning, water heater installation, and emergency services — with no hidden fees
